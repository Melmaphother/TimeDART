...
from layers.TimeDART_backbone import (
    ChannelIndependence,
...
class TimeDARTForecasting(nn.Module):
    def __init__(self, args: Namespace, TimeDART_encoder: TimeDART):
        super(TimeDARTForecasting, self).__init__()

        self.pred_len = args.pred_len
        self.TimeDART_encoder = TimeDART_encoder
    ...
    def forward(self, x, finetune_mode: str = "fine_all"):
        if finetune_mode == "fine_all":
            ...
            with torch.no_grad():
                ...
                x = self.TimeDART_encoder(x, task="forecast")
    ...
    def freeze_encoder(self):
        for param in self.TimeDART_encoder.parameters():
